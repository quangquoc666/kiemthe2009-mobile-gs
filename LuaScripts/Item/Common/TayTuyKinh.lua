...
local TayTuyKinh = Scripts[200083]
...
-- ****************************************************** --
function TayTuyKinh:OnPreCheckCondition(scene, item, player, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> TayTuyKinh:OnPreCheckCondition")--
	-- ************************** --
	return true
	-- ************************** --
...
--		player: Player - NPC tương ứng
-- ****************************************************** --
function TayTuyKinh:OnUse(scene, item, player, otherParams)
...
-- ****************************************************** --
function TayTuyKinh:OnSelection(scene, item, player, selectionID, otherParams)

	-- ************************** --
	--player:AddNotification("Enter -> TayTuyKinh:OnSelection, selectionID = " .. selectionID)--
...
-- ****************************************************** --
function TayTuyKinh:OnItemSelected(scene, item, player, itemID)
