...
function TuiTanThu:OnSelection(scene, item, player, selectionID, otherParams)
	...
	local dialog = GUI.CreateItemDialog()
		dialog:AddText("<color=green>Hỗ Trợ Tân Thủ Kiếm Thế 2009</color>")
		...
		dialog:AddSelection(10004, "Nhận Set Đồ Theo Hệ 100 +14</color>")
	...
	elseif selectionID == 11111 then
		...
		-- Hỗ Trợ Đồ TT
		if record4 == 1 then
			TuiTanThu:ShowDialog(item, player, "Bằng hữu đã nhận <color=green>hỗ trợ tân thủ</color> trước đó, không thể nhận thêm!")
			return
		end
			...
			Player:AddItemLua(player,15020,1,0,1) --5000 NHHT
			Player.AddMoney(player,500000,0)
			Player.AddMoney(player,5000,3)
			local Prestige = (player:GetPrestige()+50);
			player:SetPrestige(Prestige)
			 for i=1,10 do 
				Player.SaveLifeSkillLevel(player,i, 80);
			 end
			Player.SetValueOfForeverRecore(player, Record4, 1)
			player:AddNotification("Bạn đã nhận Hỗ Trợ Tân Thủ Của Kiếm Thế 2009 Thành Công !!!")
			GUI.CloseDialog(player)
	...
	if selectionID == 17023 then
		...
		elseif player:GetFactionID()~=0 then
			if player:GetFactionID()==1 then
				if player:GetSex()==0 then
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID1,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID2,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID3,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID4,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID5,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID6,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID7,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID8,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID9,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID10,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID11,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID12,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID13,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID23,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID26,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID25,1,-1,1)
				...
				elseif player:GetSex()==1 then
					...
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID12,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID13,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID14,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID15,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID16,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID17,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID18,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID19,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID20,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID21,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID22,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID23,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID26,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID25,1,-1,1)
					Player.SetValueOfForeverRecore(player, Record3, 1)
			...
			elseif player:GetFactionID()==3 then
				if player:GetSex()==0 then
					...
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID13,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID25,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID27,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID28,1,-1,1)
					Player.SetValueOfForeverRecore(player, Record3, 1)
				elseif player:GetSex()==1 then
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID10,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID11,1,-1,1)
					...
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID21,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID22,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID23,1,-1,1)
					TuiTanThu:SetBelonging89CH7(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID24,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID25,1,-1,1)
					-- TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID26,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID27,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID28,1,-1,1)
			...
			elseif player:GetFactionID()==4 then
				if player:GetSex()==0 then
					...
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID13,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID25,1,-1,1)
					-- TuiTanThu:SetItemKhongCH(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID26,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID27,1,-1,1)
					TuiTanThu:SetItemKhongCHCoHSD(item,player,SetTanThu100CoNgua[player:GetFactionID()].ItemID28,1,-1,1)
					Player.SetValueOfForeverRecore(player, Record3, 1)
				elseif player:GetSex()==1 then
...
function TuiTanThu:SetItemKhongCHCoHSD(item, player, ItemID,Number,Series,LockStatus)
...
function TuiTanThu:SetBelonging89CH7(item, player, ItemID,Number,Series,LockStatus)
	...
	TuiTanThu:ShowDialog(item, player,"Nhận phẩm thành công theo hệ <color=red>Thành công !+8</color>")
	-- ************************** --
end
